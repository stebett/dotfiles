...
" Version:     4.1.0
" Last Change: 2018-Aug-19
" Website:     http://www.vim.org/scripts/script.php?script_id=4136
" Github Repo: https://github.com/sonobre/briofita_vim
" NOTES:       The current version of this colorscheme is for Vim running the
"              GUI or running in terminals up from 256 colors. For any additional
"              information, including the changelog, please check the helpfile.
" =============================================================================
...
if !exists("g:briofita_skip_termguicolors")
    if (v:version >= 800) && (exists("&tgc"))
        set termguicolors
    endif
endif

if !exists("g:briofita_skip_guicursor")   " GUI cursor
    set guicursor+=i-ci:ver30-iCursor-blinkwait300-blinkon200-blinkoff150
endif

" ]]]1

hi Normal guifg=PowderBlue guibg=#062926 ctermfg=0 ctermbg=16 cterm=NONE
...
hi AptConfError                           guifg=#54B3BF          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
hi AptConfOperator                        guifg=#B78669          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
hi asciidocAdmonition                     guifg=#4DBCBC          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
...
hi asciidocAnchorMacro                    guifg=#593BAB          guibg=bg gui=NONE  ctermfg=61 ctermbg=bg cterm=NONE
...
hi asciidocAttributeMacro                 guifg=DodgerBlue2      guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi asciidocAttributeRef                   guifg=#B77669          guibg=#152933 gui=NONE  ctermfg=137 ctermbg=17 cterm=NONE
hi asciidocBackslash                      guifg=#009080          guibg=bg gui=NONE  ctermfg=30 ctermbg=bg cterm=NONE
hi asciidocBiblio                         guifg=#2DB3A0          guibg=bg gui=NONE  ctermfg=37 ctermbg=bg cterm=NONE
hi asciidocBlockTitle                     guifg=#4BB333          guibg=bg gui=italic  ctermfg=71 ctermbg=bg cterm=italic
...
hi asciidocEmail                          guifg=CornflowerBlue   guibg=bg gui=underline  ctermfg=0 ctermbg=bg cterm=underline
...
hi asciidocFootnote                       guifg=SkyBlue3         guibg=Gray20 gui=NONE  ctermfg=0 ctermbg=16 cterm=NONE
...
hi asciidocIndexTerm                      guifg=#593BAB          guibg=Gray10 gui=NONE  ctermfg=61 ctermbg=0 cterm=NONE
hi asciidocLineBreak                      guifg=Gray60           guibg=bg gui=NONE  ctermfg=17 ctermbg=bg cterm=NONE
hi asciidocLink                           guifg=#8870FF          guibg=bg gui=underline  ctermfg=99 ctermbg=bg cterm=underline
hi asciidocList                           guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi asciidocListBullet                     guifg=#A77669          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
hi asciidocListContinuation               guifg=Gray50           guibg=bg gui=NONE  ctermfg=17 ctermbg=bg cterm=NONE
hi asciidocListingBlock                   guifg=IndianRed3       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi asciidocListLabel                      guifg=MediumSeaGreen   guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi asciidocListNumber                     guifg=#D18778          guibg=bg gui=NONE  ctermfg=174 ctermbg=bg cterm=NONE
...
hi asciidocMacro                          guifg=#909966          guibg=bg gui=NONE  ctermfg=101 ctermbg=bg cterm=NONE
hi asciidocMacroAttributes                guifg=SlateBlue2       guibg=bg gui=NONE  ctermfg=20 ctermbg=bg cterm=NONE
...
hi asciidocQuotedBold                     guifg=#BB9293          guibg=bg gui=italic  ctermfg=138 ctermbg=bg cterm=italic
...
hi asciidocQuotedEmphasized               guifg=#CC4488          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi asciidocQuotedEmphasized2              guifg=#CC4488          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi asciidocQuotedSubscript                guifg=#73A6B9          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
hi asciidocQuotedSuperscript              guifg=LightSeaGreen    guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi asciidocQuotedUnconstrainedBold        guifg=#EE6F00          guibg=bg gui=italic  ctermfg=202 ctermbg=bg cterm=italic
hi asciidocQuotedUnconstrainedEmphasized  guifg=SteelBlue3       guibg=bg gui=italic  ctermfg=10 ctermbg=bg cterm=italic
hi asciidocQuotedUnconstrainedMonospaced  guifg=#CE6850          guibg=bg gui=NONE  ctermfg=167 ctermbg=bg cterm=NONE
...
hi asciidocSidebarDelimiter               guifg=#BB3333          guibg=bg gui=NONE  ctermfg=131 ctermbg=bg cterm=NONE
...
hi AutoHyperlinkURL                       guifg=#39B3B3          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
...
hi bashStatement                          guifg=SlateGray3       guibg=bg gui=underline  ctermfg=0 ctermbg=bg cterm=underline
hi BG000000                               guifg=Black            guibg=Gray80 gui=NONE  ctermfg=34 ctermbg=18 cterm=NONE
...
hi bufferGatorBufferNr                    guifg=#808080          guibg=bg gui=NONE  ctermfg=244 ctermbg=bg cterm=NONE
...
hi bufferGatorSymbol                      guifg=Brown2           guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi BufferSaurusSyntaxContextedKeyDesc     guifg=#9CBE9E          guibg=bg gui=italic  ctermfg=145 ctermbg=bg cterm=italic
...
hi cssAdvancedProp                        guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssAuralProp                           guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssBackgroundAttr                      guifg=#8870FF          guibg=bg gui=NONE  ctermfg=99 ctermbg=bg cterm=NONE
hi cssBackgroundProp                      guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssBorderOutlineProp                   guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssBorderProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssBoxProp                             guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssColorProp                           guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssCommonProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssDefinition                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssFontDescriptorProp                  guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssFontProp                            guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssGeneratedContentProp                guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssListProp                            guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssMarginProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssPaddingProp                         guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssPagingAttr                          guifg=Ivory3           guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi cssPagingProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssPositioningAttr                     guifg=#8870FF          guibg=bg gui=NONE  ctermfg=99 ctermbg=bg cterm=NONE
hi cssPositioningProp                     guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssProp                                guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssRenderProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssStyle                               guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssTableAttr                           guifg=Ivory3           guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi cssTableProp                           guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssTextProp                            guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssUIattr                              guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
hi cssUIProp                              guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cssVisualProp                          guifg=#C74688          guibg=bg gui=NONE  ctermfg=168 ctermbg=bg cterm=NONE
...
hi cStorageClass                          guifg=Snow3            guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi CursorColumn                           guifg=#DCCCA7          guibg=#80008F gui=NONE  ctermfg=187 ctermbg=90 cterm=NONE
...
hi diffAdd                                guifg=#69F669          guibg=#0A0A4E gui=NONE  ctermfg=83 ctermbg=17 cterm=NONE
hi diffAdded                              guifg=#69F669          guibg=#0A0A4E gui=NONE  ctermfg=83 ctermbg=17 cterm=NONE
...
hi diffText                               guifg=#FF47FF          guibg=#062946 gui=underline
...
hi errorMsg                               guifg=IndianRed        guibg=bg gui=underline  ctermfg=0 ctermbg=bg cterm=underline
...
hi fileSearchSyntaxFileGroupTitle         guifg=DarkCyan         guibg=bg gui=underline  ctermfg=160 ctermbg=bg cterm=underline
...
hi FoldColumn                             guifg=#593BAB          guibg=#082926 gui=NONE  ctermfg=61 ctermbg=0 cterm=NONE
...
hi gitHash                                guifg=#D2C000          guibg=bg gui=NONE  ctermfg=178 ctermbg=bg cterm=NONE
hi gitHashAbbrev                          guifg=#D2C000          guibg=bg gui=NONE  ctermfg=178 ctermbg=bg cterm=NONE
hi gitHead                                guifg=#CC8588          guibg=bg gui=NONE  ctermfg=174 ctermbg=bg cterm=NONE
...
hi GrubCommand                            guifg=#FF47FF          guibg=bg gui=NONE  ctermfg=207 ctermbg=bg cterm=NONE
hi GrubNumbers                            guifg=#FF8844          guibg=bg gui=NONE  ctermfg=209 ctermbg=bg cterm=NONE
...
hi helpBacktick                           guifg=DodgerBlue       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpBar                                guifg=FireBrick1       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpBox1                               guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi helpBox2                               guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi helpBox3                               guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi helpBox4                               guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi helpBox5                               guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi helpCommand                            guifg=DodgerBlue       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpExample                            guifg=#B09A69          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi helpHeader                             guifg=LightGreen       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpHeadline                           guifg=#009953          guibg=bg gui=italic  ctermfg=29 ctermbg=bg cterm=italic
hi helpHypertextEntry                     guifg=#46B97E          guibg=bg gui=NONE  ctermfg=72 ctermbg=bg cterm=NONE
hi helpHypertextJump                      guifg=#C090A0          guibg=bg gui=italic  ctermfg=139 ctermbg=bg cterm=italic
hi helpIgnore                             guifg=bg               guibg=bg gui=NONE  ctermfg=bg ctermbg=16 cterm=NONE
hi helpNote                               guifg=#D869E6          guibg=bg gui=italic  ctermfg=170 ctermbg=bg cterm=italic
hi helpNotVi                              guifg=SteelBlue2       guibg=bg gui=NONE  ctermfg=10 ctermbg=bg cterm=NONE
hi helpOption                             guifg=#EF6080          guibg=bg gui=NONE  ctermfg=204 ctermbg=bg cterm=NONE
hi helpSection                            guifg=SkyBlue3         guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpSectionDelim                       guifg=#00B780          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
...
hi helpSpecial                            guifg=#5DB99C          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
hi helpStar                               guifg=#38996C          guibg=bg gui=NONE  ctermfg=65 ctermbg=bg cterm=NONE
hi helpTitle                              guifg=DodgerBlue       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi helpTodo                               guifg=#7EB49C          guibg=bg gui=NONE  ctermfg=109 ctermbg=bg cterm=NONE
hi helpURL                                guifg=SteelBlue2       guibg=bg gui=underline  ctermfg=10 ctermbg=bg cterm=underline
...
hi javaClassDecl                          guifg=DarkGray         guibg=bg gui=underline  ctermfg=160 ctermbg=bg cterm=underline
...
hi javaConditional                        guifg=#00AF6F          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
...
hi javaFold                               guifg=MediumOrchid     guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi javaInParen                            guifg=#7EAA9C          guibg=bg gui=NONE  ctermfg=109 ctermbg=bg cterm=NONE
...
hi javaParen                              guifg=#7EB49C          guibg=bg gui=NONE  ctermfg=109 ctermbg=bg cterm=NONE
hi javaParenError                         guifg=#7EB49C          guibg=bg gui=NONE  ctermfg=109 ctermbg=bg cterm=NONE
hi javaParenT                             guifg=#A6A069          guibg=bg gui=NONE  ctermfg=143 ctermbg=bg cterm=NONE
...
hi javaRepeat                             guifg=SeaGreen3        guibg=bg gui=underline  ctermfg=0 ctermbg=bg cterm=underline
...
hi javaScript_Math                        guifg=#009F6F          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
...
hi javascriptBCollectionAttrs             guifg=#A969FF          guibg=bg gui=NONE  ctermfg=135 ctermbg=bg cterm=NONE
hi javascriptBModel                       guifg=#BD50DD          guibg=bg gui=NONE  ctermfg=134 ctermbg=bg cterm=NONE
hi javascriptBoolean                      guifg=#A8B0AA          guibg=bg gui=NONE  ctermfg=145 ctermbg=bg cterm=NONE
hi javascriptBraces                       guifg=#2F98A6          guibg=bg gui=NONE  ctermfg=31 ctermbg=bg cterm=NONE
...
hi javascriptConditional                  guifg=#DC98FF          guibg=bg gui=NONE  ctermfg=177 ctermbg=bg cterm=NONE
...
hi javaScriptEndColons                    guifg=#A8C0AA          guibg=bg gui=bold  ctermfg=145 ctermbg=bg cterm=bold
...
hi javascriptFuncDef                      guifg=#E19FA1          guibg=bg gui=NONE  ctermfg=181 ctermbg=bg cterm=NONE
...
hi javascriptGlobal                       guifg=#66B8B8          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
hi javaScriptGlobalObjects                guifg=#0070F0          guibg=bg gui=NONE  ctermfg=27 ctermbg=bg cterm=NONE
...
hi javaScriptLDot                         guifg=#F191F1          guibg=bg gui=NONE  ctermfg=213 ctermbg=bg cterm=NONE
...
hi javaScriptOpSymbols                    guifg=#2DC3C0          guibg=bg gui=NONE  ctermfg=37 ctermbg=bg cterm=NONE
hi javaScriptParens                       guifg=SlateGray3       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi javaScriptQcore                        guifg=#3194FF          guibg=bg gui=NONE  ctermfg=69 ctermbg=bg cterm=NONE
hi javaScriptQdata                        guifg=#21B43B          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
hi javaScriptQdeferred                    guifg=#21B43B          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
...
hi javaScriptSource                       guifg=#9CBE9E          guibg=bg gui=NONE  ctermfg=145 ctermbg=bg cterm=NONE
...
hi javascriptString                       guifg=LightSkyBlue3    guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi javaStorageClass                       guifg=Snow3            guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi javaString                             guifg=#7EB49C          guibg=bg gui=NONE  ctermfg=109 ctermbg=bg cterm=NONE
...
hi juliaNumber                            guifg=#98bc37          guibg=bg gui=NONE  ctermfg=7 ctermbg=bg cterm=NONE
hi juliaOctalEscapeChar                   guifg=DodgerBlue1      guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi juliaOperator                          guifg=#adaaa4          guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi lispAtom                               guifg=#00A84F          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
hi lispAtomList                           guifg=#8870FF          guibg=bg gui=NONE  ctermfg=99 ctermbg=bg cterm=NONE
hi lispAtomMark                           guifg=#80DF8F          guibg=bg gui=NONE  ctermfg=114 ctermbg=bg cterm=NONE
hi lispComment                            guifg=#5D5C9C          guibg=bg gui=NONE  ctermfg=61 ctermbg=bg cterm=NONE
...
hi lispMark                               guifg=#9CBE9E          guibg=bg gui=NONE  ctermfg=145 ctermbg=bg cterm=NONE
...
hi luaString                              guifg=Thistle3         guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi luaString2                             guifg=#73AB95          guibg=bg gui=NONE  ctermfg=72 ctermbg=bg cterm=NONE
hi luaTable                               guifg=DodgerBlue2      guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi makeComment                            guifg=#5B8999          guibg=bg gui=NONE  ctermfg=66 ctermbg=bg cterm=NONE
...
hi makeDstring                            guifg=MediumSeaGreen   guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi makeIdent                              guifg=#C5A5B5          guibg=bg gui=NONE  ctermfg=181 ctermbg=bg cterm=NONE
hi makeNextLine                           guifg=#CC4455          guibg=bg gui=NONE  ctermfg=167 ctermbg=bg cterm=NONE
hi makePreCondit                          guifg=#B77669          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
hi makeSpecial                            guifg=#F98649          guibg=bg gui=NONE  ctermfg=209 ctermbg=bg cterm=NONE
hi makeSString                            guifg=#9A85FF          guibg=bg gui=NONE  ctermfg=105 ctermbg=bg cterm=NONE
hi makeTarget                             guifg=#21C43B          guibg=bg gui=NONE  ctermfg=41 ctermbg=bg cterm=NONE
...
hi manBulletZone                          guifg=#C28955          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi markdownCodeBlock                      guifg=#73A3B9          guibg=bg gui=NONE  ctermfg=73 ctermbg=bg cterm=NONE
...
hi markdownHeadingDelimiter               guifg=#F23444          guibg=bg gui=NONE  ctermfg=203 ctermbg=bg cterm=NONE
...
hi markdownListMarker                     guifg=#CC5588          guibg=bg gui=bold  ctermfg=168 ctermbg=bg cterm=bold
...
hi markdownUrl                            guifg=Turquoise3       guibg=#190835 gui=italic  ctermfg=0 ctermbg=17 cterm=italic
...
hi matchParen                             guifg=Sienna2          guibg=MediumBlue gui=bold  ctermfg=0 ctermbg=16 cterm=bold
...
hi modconfkeyword                         guifg=#B096E0          guibg=bg gui=NONE  ctermfg=140 ctermbg=bg cterm=NONE
hi modconfpreproc                         guifg=#E19FA1          guibg=bg gui=NONE  ctermfg=181 ctermbg=bg cterm=NONE
...
hi nerdtreeFile                           guifg=#2F98A6          guibg=bg gui=NONE  ctermfg=31 ctermbg=bg cterm=NONE
hi nerdtreeFlag                           guifg=#5D999C          guibg=bg gui=NONE  ctermfg=67 ctermbg=bg cterm=NONE
hi nerdtreeFlags                          guifg=#4B5FFF          guibg=bg gui=NONE  ctermfg=63 ctermbg=bg cterm=NONE
...
hi nerdtreeOpenable                       guifg=SlateGray3       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi nerdtreeRO                             guifg=#2F98A6          guibg=bg gui=NONE  ctermfg=31 ctermbg=bg cterm=NONE
...
hi netrwClassify                          guifg=#D944EE          guibg=bg gui=NONE  ctermfg=171 ctermbg=bg cterm=NONE
...
hi netrwComment                           guifg=Gray60           guibg=bg gui=NONE  ctermfg=17 ctermbg=bg cterm=NONE
...
hi netrwPix                               guifg=#996644          guibg=bg gui=NONE  ctermfg=95 ctermbg=bg cterm=NONE
hi netrwPlain                             guifg=#2F98A6          guibg=bg gui=NONE  ctermfg=31 ctermbg=bg cterm=NONE
...
hi netrwTreeBar                           guifg=#6826AB          guibg=bg gui=NONE  ctermfg=55 ctermbg=bg cterm=NONE
...
hi Number                                 guifg=#98bc37       guibg=bg gui=NONE  ctermfg=4 ctermbg=bg cterm=NONE
...
hi Operator                               guifg=#00CCC6          guibg=bg gui=NONE  ctermfg=44 ctermbg=bg cterm=NONE
...
hi p6Float                                guifg=#C27B66          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi p6number                               guifg=#C27B66          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi perlFloat                              guifg=#C27B66          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi perlNumber                             guifg=#C27B66          guibg=bg gui=NONE  ctermfg=137 ctermbg=bg cterm=NONE
...
hi perlVarNotInMatches                    guifg=#409A7A          guibg=bg gui=NONE  ctermfg=66 ctermbg=bg cterm=NONE
...
hi perlVarSlash                           guifg=#8898FF          guibg=bg gui=NONE  ctermfg=105 ctermbg=bg cterm=NONE
hi phpArrayPair                           guifg=#2DB3A0          guibg=bg gui=NONE  ctermfg=37 ctermbg=bg cterm=NONE
hi phpBackslashSequences                  guifg=#B2C2B2          guibg=bg gui=NONE  ctermfg=145 ctermbg=bg cterm=NONE
...
hi pl1errinbracket                        guifg=hotpink2         guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi plsqlStringLiteral                     guifg=Plum3            guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi plsqlSymbol                            guifg=#8870FF          guibg=bg gui=bold  ctermfg=99 ctermbg=bg cterm=bold
hi pMenu                                  guifg=#A4D4DA          guibg=#003853 gui=NONE  ctermfg=152 ctermbg=23 cterm=NONE
...
hi pythonExtraOperator                    guifg=#66CC66          guibg=bg gui=NONE  ctermfg=77 ctermbg=bg cterm=NONE
...
hi pythonUniString                        guifg=#829080          guibg=bg gui=NONE  ctermfg=102 ctermbg=bg cterm=NONE
hi qfDirectory                            guifg=#55A555          guibg=bg gui=NONE  ctermfg=71 ctermbg=bg cterm=NONE
hi qfError                                guifg=#5D8B9C          guibg=bg gui=NONE  ctermfg=67 ctermbg=bg cterm=NONE
hi qfFileName                             guifg=SteelBlue3       guibg=bg gui=NONE  ctermfg=10 ctermbg=bg cterm=NONE
hi qfLineNr                               guifg=DarkSeaGreen4    guibg=bg gui=NONE  ctermfg=160 ctermbg=bg cterm=NONE
hi qfSeparator                            guifg=#73A3C3          guibg=bg gui=bold  ctermfg=73 ctermbg=bg cterm=bold
hi question                               guifg=DodgerBlue2      guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi quickfixLine                           guifg=#FF4422          guibg=bg gui=NONE  ctermfg=202 ctermbg=bg cterm=NONE
...
hi rubyConstant                           guifg=#9CBE9E          guibg=bg gui=NONE  ctermfg=145 ctermbg=bg cterm=NONE
...
hi rubyEval                               guifg=OliveDrab2       guibg=bg gui=NONE  ctermfg=21 ctermbg=bg cterm=NONE
hi rubyException                          guifg=LightGreen       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi rubyFunction                           guifg=DarkOrange3      guibg=bg gui=underline  ctermfg=160 ctermbg=bg cterm=underline
...
hi rubyMacro                              guifg=OliveDrab1       guibg=bg gui=NONE  ctermfg=21 ctermbg=bg cterm=NONE
hi rubyMethod                             guifg=khaki2           guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi shDeRefSimple                          guifg=#33943B          guibg=bg gui=NONE  ctermfg=65 ctermbg=bg cterm=NONE
...
hi shNumber                               guifg=#81AB81          guibg=bg gui=NONE  ctermfg=108 ctermbg=bg cterm=NONE
hi shOperator                             guifg=VioletRed2       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi shOption                               guifg=Orchid3          guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi shStatement                            guifg=LightBlue        guibg=bg gui=underline  ctermfg=0 ctermbg=bg cterm=underline
...
hi Special                                guifg=#63AD9C          guibg=Gray20 gui=NONE  ctermfg=73 ctermbg=0 cterm=NONE
...
hi SpellBad                               guifg=fg               guibg=bg gui=undercurl guisp=Yellow
hi SpellCap                               guifg=fg               guibg=bg gui=undercurl guisp=#CCFFCC
hi SpellLocal                             guifg=fg               guibg=bg gui=undercurl guisp=fg
hi SpellRare                              guifg=fg               guibg=bg gui=undercurl guisp=#C59F6F
hi sqlFold                                guifg=#00B39B          guibg=bg gui=NONE  ctermfg=36 ctermbg=bg cterm=NONE
hi sqlHibSnippet                          guifg=Salmon3          guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi sqlType                                guifg=Snow3            guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi StatusLineTerm                         guifg=MistyRose        guibg=LightBlue4 gui=NONE  ctermfg=0 ctermbg=16 cterm=NONE
hi StatusLineTermNC                       guifg=LightBlue        guibg=LightBlue4 gui=NONE  ctermfg=0 ctermbg=16 cterm=NONE
hi storageClass                           guifg=#C59F6F          guibg=bg gui=NONE  ctermfg=179 ctermbg=bg cterm=NONE
hi String                                 guifg=#73AB95          guibg=bg gui=NONE  ctermfg=72 ctermbg=bg cterm=NONE
hi stringDelimiter                        guifg=#73AB95          guibg=bg gui=NONE  ctermfg=72 ctermbg=bg cterm=NONE
...
hi syntasticError                         guifg=fg               guibg=bg      gui=undercurl      guisp=Tomato
...
hi syntasticWarning                       guifg=fg               guibg=bg      gui=undercurl      guisp=LightGray
hi syntasticWarningSign                   guifg=MediumPurple4    guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi tabLine                                guifg=#55B5E3          guibg=#6F0F43 gui=underline  ctermfg=74 ctermbg=53 cterm=underline
hi tabLineClose                           guifg=CornflowerBlue   guibg=Gray26 gui=NONE  ctermfg=0 ctermbg=16 cterm=NONE
hi tabLineFill                            guifg=CornflowerBlue   guibg=Black gui=NONE  ctermfg=0 ctermbg=34 cterm=NONE
hi tabLineNumber                          guifg=#3CEEB3          guibg=bg gui=NONE  ctermfg=85 ctermbg=bg cterm=NONE
hi tabLineSel                             guifg=SeaGreen1        guibg=Black gui=NONE  ctermfg=0 ctermbg=34 cterm=NONE
...
hi Terminal                               guifg=#21C43B          guibg=#1E3B31 gui=NONE  ctermfg=41 ctermbg=23 cterm=NONE
...
hi tjpblk_macro                           guifg=BurlyWood3       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi vimExecute                             guifg=#CC4455          guibg=bg gui=NONE  ctermfg=167 ctermbg=bg cterm=NONE
hi vimFBvar                               guifg=#829080          guibg=bg gui=NONE  ctermfg=102 ctermbg=bg cterm=NONE
...
hi vimFuncBody                            guifg=#2FBB66          guibg=bg gui=NONE  ctermfg=35 ctermbg=bg cterm=NONE
...
hi vimHLGroup                             guifg=#0099FF          guibg=#1C3644 gui=NONE  ctermfg=33 ctermbg=23 cterm=NONE
...
hi vimMenuNameMore                        guifg=#85B2FE          guibg=bg gui=NONE  ctermfg=111 ctermbg=bg cterm=NONE
...
hi vimWikiHeader1                         guifg=#F00044          guibg=bg gui=NONE  ctermfg=197 ctermbg=bg cterm=NONE
...
hi warningMsg                             guifg=SeaGreen2        guibg=bg gui=italic  ctermfg=0 ctermbg=bg cterm=italic
...
hi wildMenu                               guifg=Black            guibg=LimeGreen gui=italic,underline  ctermfg=34 ctermbg=0 cterm=italic,underline
...
hi xmlEndTag                              guifg=#70A88F          guibg=bg gui=NONE  ctermfg=72 ctermbg=bg cterm=NONE
hi xmlEntity                              guifg=#D88DD8          guibg=bg gui=NONE  ctermfg=176 ctermbg=bg cterm=NONE
hi xmlEntityPunct                         guifg=#38ADD8          guibg=bg gui=NONE  ctermfg=74 ctermbg=bg cterm=NONE
...
hi xpmComment                             guifg=#FFC8AD          guibg=Gray20 gui=italic  ctermfg=223 ctermbg=0 cterm=italic
hi xpmPixelString                         guifg=#FFC8AD          guibg=bg gui=NONE  ctermfg=223 ctermbg=bg cterm=NONE
hi xpmStorageClass                        guifg=SeaGreen2        guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi xpmType                                guifg=SeaGreen2        guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi xpmValues                              guifg=DarkSeaGreen3    guibg=bg gui=NONE  ctermfg=160 ctermbg=bg cterm=NONE
hi xslElement                             guifg=#BC9495          guibg=bg gui=NONE  ctermfg=138 ctermbg=bg cterm=NONE
...
hi yamlBlockCollectionItemStart           guifg=SeaGreen2        guibg=bg gui=bold  ctermfg=0 ctermbg=bg cterm=bold
...
hi yamlFloat                              guifg=#E3B9DC          guibg=bg gui=NONE  ctermfg=182 ctermbg=bg cterm=NONE
hi yamlFlowIndicator                      guifg=SeaGreen2        guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
hi yamlFlowMapping                        guifg=IndianRed2       guibg=bg gui=NONE  ctermfg=0 ctermbg=bg cterm=NONE
...
hi yamlInteger                            guifg=#E3B9DC          guibg=bg gui=NONE  ctermfg=182 ctermbg=bg cterm=NONE
...
hi zimbuCompType                          guifg=DarkGray         guibg=bg gui=NONE  ctermfg=160 ctermbg=bg cterm=NONE
