...
let g:colors_name = "custom"
  " "string"     => "#918175"
hi JuliaString guifg=#918175
  " "number"     => "#98bc37"
hi JuliaNumber guifg=#98bc37
  " "variable"   => "#adaaa4"
  " "comment"    => "#918175"
hi JuliaComment guifg=#918175
  " "macro"      => "#0aaeb3"
hi JuliaMacro guifg=#0aaeb3
  " "symbol"     => "#98bc37"
hi JuliaSymbol guifg=#98bc37
  " "operator"   => "#adaaa4"
hi JuliaOperator guifg=#adaaa4
  " "funcdef"    => "#e02c6d"
  " "funccall"   => "#0aaeb3"
  " "keyword"    => "#ff3128"
hi JuliaKeyword guifg=#ff3128
  " "type"       => "#adaaa4"
  " "background" => "#1c1b19"
